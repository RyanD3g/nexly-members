...
import { UpdateAddressImplementation } from "src/repositories/Student/implementations/UpdateAddress.service";
...
export class UpdateAddressModule implements NestModule {
    configure(consumer: MiddlewareConsumer) {
        consumer
            .apply(IsJwtMiddleware)
                .forRoutes('update/address/student')
    };
};
